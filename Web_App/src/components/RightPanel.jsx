...
/* ─── Migration Panel ─────────────────────────────────────────────────────── */
function MigrationPanel({ activeFile, migration, onMigration, theme }) {
    ...
    return (
        <div style={{ display: 'flex', flexDirection: 'column', height: '100%', background: bg }}>
            ...
            <div style={{ flex: 1, overflow: 'hidden' }}>
                ...
                {activeTab === 'migration' && <MigrationPanel activeFile={activeFile} migration={lastMigration} onMigration={setLastMigration} theme={theme} />}
